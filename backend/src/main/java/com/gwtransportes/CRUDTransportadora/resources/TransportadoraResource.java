...
import com.gwtransportes.CRUDTransportadora.services.TransportadoraService;
...
public class TransportadoraResource {
	...
	public ResponseEntity<List<TransportadoraDTO>> findAll() {
		List<TransportadoraDTO> list = service.findAll();
	...
	public ResponseEntity<TransportadoraDTO> delete(@PathVariable Long id) {
		service.delete(id);
